...
class Add(Resource):
    def post(self):
        ...
        if money <= 0:
            return jsonify(generateReturnDictionary(304, 'The money amount must be greater then 0'))
...
class PayLoan(Resource):
    def post(self):
        ...
        return jsonify(generateReturnDictionary(200, "You're successfully paid your loan"))
